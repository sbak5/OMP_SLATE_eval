...
#if INTEROP_OMP
void FTN_STDCALL KMP_EXPAND_NAME(FTN_SET_GANG_SCHED)() {
    __kmp_set_gang_sched(__kmp_entry_gtid(), 0);
}

void FTN_STDCALL KMP_EXPAND_NAME(FTN_RESET_GANG_SCHED)() {
    __kmp_set_gang_sched(__kmp_entry_gtid(), 1);
}
#endif
