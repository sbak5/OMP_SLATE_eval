...
#if !INTEROP_OMP && (KMP_OS_LINUX || KMP_OS_WINDOWS) && !KMP_OS_CNK
...
//#include <stdatomic.h>
#define TCR_1(a) (__atomic_load_n(&a, __ATOMIC_ACQUIRE))
#define TCW_1(a, b) (__atomic_store_n(&a, b, __ATOMIC_RELEASE)) // (a) = (b)
#define TCR_4(a) (__atomic_load_n(&a, __ATOMIC_ACQUIRE))
#define TCW_4(a, b) (__atomic_store_n(&a, b, __ATOMIC_RELEASE)) // (a) = (b)
#define TCI_4(a) (++(a))
#define TCD_4(a) (--(a))
#define TCR_8(a) (a)
...
#elif KMP_ARCH_ARM || KMP_ARCH_PPC64
